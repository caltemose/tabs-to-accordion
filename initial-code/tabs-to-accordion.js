...
// or
// https://github.com/mpiotrowicz/a11y-sandbox/blob/master/source/javascripts/prototypes/responsive-tabs.js
...
(function () {
  ...
  Tabs = (function () {
    ...
    function getTabsMarkup(tabs) {
      var html = "<ul class='inline-list tabs-navigation show-desktop' role='tablist'>";
      for(var i=0; i<tabs.length; i++) {
        var tab = tabs[i];
        html += "<li role='presentation' class='tab-menu-item'><a href='#";
        html += tab.tabId;
        html += "' id='TabController-" + tab.tabId;
        html += "' class='txt-btn tabs-navigation__button' role='tab' aria-selected='false' aria-controls='";
        html += tab.tabId + "' aria-expanded='false'>" + tab.tabTitle + "</a>";
        // down arrow indicator for selected navigation items
        // html += '<span class="indicator"><span class="indicator-down"></span><span class="indicator-down-fill"></span></span>';
        html += "</li>";
      }
      html += "</ul>";
      return html;
    ...
    */
    Tabs.prototype.createTabNav = function () {
      ...
      this.$tabNav = $(getTabsMarkup(this.tabData)).prependTo(this.$container);
    ...
    */
    Tabs.prototype.openAccordion = function ($tab_panel) {
      ...
      $("html, body").animate({
        scrollTop: $tab_panel.offset().top - 230
      }, 250);
    };
    ...
    */
    Tabs.prototype.init = function () {
      ...
      console.log('this.$accordion.height()', this.$accordion.height());
      console.log('this.$tab_panels', this.$tab_panels);
      var heights = [];
      var maxHeight = 0;
      this.$tab_panels.each(function () {
      ...
      this.$accordion.height(maxHeight);
      */
    };
  ...
  $(function () {
    console.log('setting window.Tabs');
    window.Tabs = Tabs;
